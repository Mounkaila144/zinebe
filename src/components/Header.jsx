...
export const Header = ({toggleDarkMode}) => {
    ...
    return (
        ...
        <nav
            className="fixed top-0 left-0 w-full bg-gray-100 border-gray-200 dark:bg-gray-900 border-b dark:border-gray-200 z-50">
                        ...
                        <div>
                            ...
                            <div
                                ...
                                {isAuthenticated && user && (
                                    ...
                                    <span
                                    className="block text-sm  text-gray-500 truncate dark:text-gray-400 text-center text-blue-600">{user.role}</span>
                                    </div>
                                    ...
                                    <li>
                                        <button onClick={()=>{
                                            logout()
                                                ...
                                                className="block px-4 py-2 text-sm text-red-700 hover:bg-red-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">
                                            Deconnexion
                                        </button>
                                    </li>
                                </ul>
                    ...
                    <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        ...
                        {isAdmin &&
                            <>
                                <li>
                                    <Link to="/product"
                                          class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-red-700 md:p-0 dark:text-white md:dark:hover:text-red-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Products</Link>
                                </li>

                                <li>
                                    <Link to="/category"
                                          class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-red-700 md:p-0 dark:text-white md:dark:hover:text-red-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Categorory</Link>
                                </li>
                            </>
                        }
